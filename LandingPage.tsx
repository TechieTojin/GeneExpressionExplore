      ...
      >
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/register" className="flex items-center gap-2">
            <span className="relative z-10 group-hover:text-health-accent transition-colors duration-300">Get Started</span>
          </Link>
        </div>
      </nav>
          ...
          >
            ...
            >
              <Link to="#how-it-works" className="flex items-center gap-2">
                <span className="relative z-10 group-hover:text-health-accent transition-colors duration-300">Learn More</span>
...
const features = [
  ...
  },
  {
    ...
    description: "Track your health metrics in real-time with smart devices",
    icon: Activity,
  },
  {
  ...
  },
  {
    ...
    description: "Get AI-powered coaching tailored to your goals",
    icon: MessageSquare,
  },
];
