...
const SleepInsights = () => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-indigo-900 via-purple-900 to-slate-800 text-white mb-4">
        ...
        <div className="relative p-6 md:p-8">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-center gap-4">
              <motion.div
                className="h-16 w-16 rounded-full bg-gradient-to-br from-indigo-600/40 to-purple-600/30 flex items-center justify-center shadow-lg"
                animate={{ 
                  boxShadow: ['0 0 0 rgba(139, 92, 246, 0.3)', '0 0 25px rgba(139, 92, 246, 0.7)', '0 0 0 rgba(139, 92, 246, 0.3)']
                }}
              ...
              >
                <motion.div
                  ...
                  className="absolute inset-0 rounded-full border-2 border-purple-400/30 border-t-purple-400/80"
                />
            ...
            <div className="flex items-center gap-3">
              <Button className="bg-white/10 hover:bg-white/20 text-white border-0 shadow-md">
        ...
        <TabsContent value="overview" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
              ...
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-gray-400">Last Night's Sleep</CardTitle>
                <div className="flex items-baseline">
                  <span className="text-3xl font-bold text-white">{todayData.hoursSlept}</span>
                  <span className="text-sm ml-1 text-gray-400">hours</span>
                </div>
              </CardHeader>
              <CardContent>
                <div className="flex items-center justify-between text-sm">
                  <div className="flex items-center gap-1">
                    ...
                    <span className="text-gray-300">{todayData.bedtime}</span>
                  </div>
                  <div className="text-gray-500">→</div>
                  <div className="flex items-center gap-1">
                    <Sunrise className="h-4 w-4 text-indigo-400" />
                    <span className="text-gray-300">{todayData.wakeup}</span>
                  </div>
                </div>
                <Progress value={Math.min((todayData.hoursSlept/9) * 100, 100)} className="h-2 mt-3 bg-gray-700" />
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
              ...
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-gray-400">Weekly Average</CardTitle>
                <div className="flex items-baseline">
                  <span className="text-3xl font-bold text-white">{weeklyAverage}</span>
                  <span className="text-sm ml-1 text-gray-400">hours</span>
                </div>
              </CardHeader>
              <CardContent>
                <div className="flex items-center gap-2 mt-2">
                  <Badge className={`px-2 py-1 rounded-md ${isImproving ? 'bg-green-900/30 text-green-300' : 'bg-red-900/30 text-red-300'}`}>
                    {isImproving ? (
                ...
                <div className="mt-4">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    <span className="text-xs font-medium text-gray-300">{todayData.quality}%</span>
                  </div>
                  <Progress value={todayData.quality} className="h-2 bg-gray-700" />
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800 text-white overflow-hidden">
              ...
              <CardHeader className="pb-2">
                <CardTitle className="text-sm text-gray-400">Sleep Score</CardTitle>
                <div className="flex items-baseline">
                ...
                <div className="grid grid-cols-2 gap-2 mt-2">
                  {sleepScoreInfo.map((item, index) => (
                    <div key={index} className="flex flex-col">
                      ...
                      <Progress value={item.value} className="h-2 bg-gray-700" />
                    </div>
                  ))}
                </div>
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800 text-white">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Breakdown of your sleep stages</CardDescription>
            </CardHeader>
                    ...
                    {sleepStageData.map((stage, index) => (
                      <div key={index}>
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-sm text-gray-300">{stage.value} hrs ({Math.round((stage.value / todayData.hoursSlept) * 100)}%)</span>
                        </div>
                        <Progress 
          ...
          <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800 text-white">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Your sleep duration over the past week</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <BarChart data={sleepData.slice(-7)}>
                    ...
                    <YAxis domain={[0, 10]} tickCount={6} tick={{ fill: '#9ca3af' }} />
                    <Tooltip 
        ...
        <TabsContent value="patterns" className="space-y-6">
          <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800 text-white">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Visualization of your sleep stages throughout the night</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800 text-white">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Your bedtime over the past week</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800 text-white">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Your wake-up time over the past week</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64">
                  <ResponsiveContainer width="100%" height="100%">
                    <LineChart data={sleepData.slice(-7)}>
                      ...
                      />
                      <Tooltip 
                        formatter={(value) => [value, 'Wake-up Time']} 
                        contentStyle={{ backgroundColor: '#1f2937', borderColor: '#374151', color: '#f9fafb' }}
                        labelStyle={{ color: '#f9fafb' }}
                      />
                      <Line 
        ...
        <TabsContent value="trends" className="space-y-6">
          <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800 text-white">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Your sleep quality and duration over time</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="h-80">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={sleepData}>
                    <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#374151" />
                    <XAxis dataKey="date" tick={{ fill: '#9ca3af' }} />
                    <YAxis yAxisId="left" domain={[0, 10]} tickCount={6} tick={{ fill: '#9ca3af' }} />
                    <YAxis yAxisId="right" orientation="right" domain={[0, 100]} tickCount={6} tick={{ fill: '#9ca3af' }} />
                    <Tooltip 
                      contentStyle={{ backgroundColor: '#1f2937', borderColor: '#374151', color: '#f9fafb' }}
                      labelStyle={{ color: '#f9fafb' }}
                    />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800 text-white">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Recommendations to improve your sleep quality</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {sleepTips.map((tip, index) => (
                    <div key={index} className="p-3 rounded-lg bg-slate-800/50 border border-slate-700/50">
                      <div className="flex items-start gap-3">
                        <div className="rounded-full bg-indigo-900/30 p-2 mt-0.5">
                          <Moon className="h-4 w-4 text-indigo-400" />
                        </div>
                        <div>
                          <div className="font-medium text-white">{tip.title}</div>
                          <div className="text-sm text-gray-400 mt-1">{tip.description}</div>
                        </div>
                      </div>
                    </div>
                  ))}
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-900 to-gray-800 text-white">
              <CardHeader>
                ...
                <CardDescription className="text-gray-400">Personalized sleep advice based on your data</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-6">
                  <div>
                    <h3 className="text-lg font-medium text-white mb-2">Your Ideal Sleep Schedule</h3>
                    <div className="grid grid-cols-2 gap-4">
                      <div className="bg-slate-800/50 p-3 rounded-lg border border-slate-700/50">
                        <div className="text-xs text-gray-400 mb-1">Bedtime</div>
                        <div className="flex items-center">
                          <BedDouble className="text-indigo-400 mr-2 h-4 w-4" />
                          <span className="text-lg font-medium text-white">10:30 PM</span>
                        </div>
                      </div>
                      <div className="bg-slate-800/50 p-3 rounded-lg border border-slate-700/50">
                        <div className="text-xs text-gray-400 mb-1">Wake Up</div>
                        <div className="flex items-center">
                          <Sunrise className="text-indigo-400 mr-2 h-4 w-4" />
                          <span className="text-lg font-medium text-white">6:30 AM</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-2 border-t border-gray-700/50">
                    <h3 className="text-lg font-medium text-white mb-2">Areas to Improve</h3>
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-300">Sleep Consistency</span>
                        <div className="w-32">
                          <Progress value={65} className="h-2 bg-gray-700" />
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-300">Deep Sleep</span>
                        <div className="w-32">
                          <Progress value={42} className="h-2 bg-gray-700" />
                        </div>
                      </div>
                      <div className="flex items-center justify-between">
                        <span className="text-sm text-gray-300">Sleep Environment</span>
                        <div className="w-32">
